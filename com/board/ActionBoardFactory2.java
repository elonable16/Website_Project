...
public class ActionBoardFactory2 {
	private static ActionBoardFactory2 instance = null;
	private ActionBoardFactory2() {}; // 싱글톤 기법, 생성을 막음
	public static ActionBoardFactory2 getInstance() {
		if(instance == null) {// 객체가 생성되어 있지 않다면 생성
			instance = new ActionBoardFactory2();
		}
		return instance;
	}
