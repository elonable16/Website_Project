...
<link rel="stylesheet" href ="${pageContext.request.contextPath}/CSS/info_operation.css">
...
<div id = "header">
    ...
    <div id = "contents">
        ...
        <div id = "main_contents">
            <div id="contents_top">
               <img src="./img/factory_img1.jpg" width="100%" height="100%">
            </div>
            <div id="middle_nav">
                <div id = "middle_nav_box">
                    <ul>
                        <li><a href="./InfoServlet?cmd=operation">경영철학</a></li>
                        <li><a href="./InfoServlet?cmd=value">핵심가치</a></li>
                        <li><a href="./InfoServlet?cmd=vision">비&nbsp&nbsp전 </a></li>
                    </ul>
                </div>
            </div>
