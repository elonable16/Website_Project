...
<link rel="stylesheet" href ="${pageContext.request.contextPath}/CSS/explain_research.css">
...
<div id = "header">
    ...
    <div id = "contents">
        ...
        <div id = "main_contents">
            <div id="contents_top">
                <!-- <img src="http://placeimg.com/1000/250/clothes" width="100%"> -->
                <p>국 내</p>
            </div>
            <div id="middle_nav">
                <div id = "middle_nav_box">
                    <ul>
                        <li><a href="./InfoServlet?cmd=business">본&nbsp&nbsp사</a></li>
                        <li><a href="./InfoServlet?cmd=factory">공&nbsp&nbsp장</a></li>
                        <li><a href="./InfoServlet?cmd=research">연 구 소</a></li>
                    </ul>
                </div>
            </div>
            <div id = "contents_bottom">
                <div id = "introduce_context">
                    <p>회사소개의 여러 내용 내용</p>
                </div>
            </div>
        </div>
