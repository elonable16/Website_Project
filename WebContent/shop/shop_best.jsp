        ...
        <div id = "main_contents">
            ...
            <div id = "intro_contents_right">
                ...
                <div id = "shop_main_item">
                    <a href ="#"><img src="./img/event1.jpg" width="100%" alt=""></a>
                </div>
                <div id="shop_item_list">
                    ...
                    <div id= shop_item_pagenum>
	                    ...
	                    <c:if test="${page.startpage>1}">
							<span><a href="./ShopServlet?cmd=shop_bestlist&pagenum=${page.startpage- page.groupsize }">◀</a></span>
						</c:if>
						<c:forEach var="i" begin="${page.startpage}" end ="${page.endpage}">
							<c:if test="${page.lastpage>=i}">
								<span><a href="./ShopServlet?cmd=shop_bestlist&pagenum=${i}">${i}</a></span>
							</c:if>
						</c:forEach>
						<c:if test="${page.endpage<page.lastpage}">
							<a href="./ShopServlet?cmd=shop_bestlist&pagenum=${page.startpage+ page.groupsize }">▶</a>
						</c:if>
                    </div>
                    </div>
                </div>
